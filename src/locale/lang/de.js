const de = {
  ...
  "Name_cannot_contain_backtick": "Der Name darf kein Backtick (`) enthalten.",
  "Table_xxx_exist": "Tabelle {name} existiert bereits.",
  ...
  "Permission_denied": "Der Zugriff wurde verweigert.",
  "Error": "Fehler",
